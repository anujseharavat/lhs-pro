            ...
            <div class="modal-body">
                ...
                <form method="post" action="/register">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-lg c-square" id="firstName" name="firstName" placeholder="First Name" value="a" required> </div>
                    <div class="form-group">
                        <label for="lastName" class="hide">Last Name</label>
                        <input type="text" class="form-control input-lg c-square" id="lastName" name="lastName" placeholder="Last Name" value="a" required> </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control input-lg c-square" id="email" name="email" placeholder="Email" value="a@a.a" required> </div>
                    <div class="form-group">
...
<div class="c-layout-page">
    ...
    <div class="c-content-box c-size-lg c-bg-parallax" style="background-image: url(assets/base/img/bg1.jpg)">
        <div class="container">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="col-md-7 col-sm-12">
                                    <ul class="c-photos">
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/7.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/9.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/2.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/3.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/4.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/5.jpg" alt="" /> </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="c-tab3-2">
                                ...
                                <div class="col-md-7">
                                    <ul class="c-photos">
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/a.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/b.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/c.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/d.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/e.jpg" alt="" /> </li>
                                        <li class="col-md-4 col-sm-4">
                                            <img class="img-responsive" src="/assets/base/img/4.jpg" alt="" /> </li>
                                    </ul>
                                </div>
            ...
            <div class="cbp-panel">
                ...
                <div class="c-content-latest-works cbp cbp-l-grid-masonry-projects wow animate fadeInLeft">
                    <div class="cbp-item graphic">
                        <div class="cbp-caption">
                            <div class="cbp-caption-defaultWrap">
                                <img src="/assets/base/img/08-long.jpg" alt=""> </div>
                    ...
                    <div class="cbp-item web-design logos wow animate fadeInLeft">
                        <div class="cbp-caption">
                            <div class="cbp-caption-defaultWrap">
                                <img src="/assets/base/img/8.jpg" alt=""> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="c-masonry-border"></div>
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item graphic logos wow animate fadeInLeft" data-wow-delay="0.2s">
                        <div class="cbp-caption">
                            <div class="cbp-caption-defaultWrap">
                                <img src="/assets/base/img/7.jpg" alt=""> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="c-masonry-border"></div>
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item identity web-design wow animate fadeInLeft" data-wow-delay="0.4s">
                        <div class="cbp-caption">
                            <div class="cbp-caption-defaultWrap">
                                <img src="/assets/base/img/9.jpg" alt=""> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="c-masonry-border"></div>
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item web-design graphic wow animate fadeInLeft">
                        <div class="cbp-caption">
                            <div class="cbp-caption-defaultWrap">
                                <img src="/assets/base/img/6.jpg" alt=""> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="c-masonry-border"></div>
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item identity web-design wow animate fadeInLeft" data-wow-delay="0.2s">
                        <div class="cbp-caption">
                            <div class="cbp-caption-defaultWrap">
                                <img src="/assets/base/img/c.jpg" alt=""> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="c-masonry-border"></div>
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item graphic logos wow animate fadeInLeft" data-wow-delay="0.4s">
                        <div class="cbp-caption">
                            <div class="cbp-caption-defaultWrap">
                                <img src="/assets/base/img/e.jpg" alt=""> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="c-masonry-border"></div>
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                ...
                <div class="c-content-pricing-1 c-opt-1">
                    <div class="col-md-3 c-sm-hidden">
                        <div class="c-content c-column-odd c-padding-adjustment">
                            ...
                            <div class="c-row c-title c-font-17">Feature 1</div>
                            <div class="c-row c-title c-font-17">Feature 2</div>
                            <div class="c-row c-title c-font-17">Feature 3</div>
                            <div class="c-row c-title c-font-17">Feature 4</div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="c-content c-column-even c-padding-adjustment">
                            <div class="c-row c-type c-font-20">Kinder</div>
                            ...
                            <div class="c-row c-purchase">
                                <button class="btn btn-md c-btn-square c-btn-green c-btn-uppercase c-btn-bold">Coming Soon</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4">
                        <div class="c-content c-column-odd c-padding-adjustment">
                            <div class="c-row c-type c-font-20">Pre-IGCSE</div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="c-content c-column-even">
                            <div class="c-row c-type c-font-20">IGCSE</div>
