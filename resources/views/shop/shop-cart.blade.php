            ...
            <div class="container">
                <div class="c-shop-cart-page-1">
                    ...
                    @foreach($products as $product)
                        <div class="row c-cart-table-row">
                            ...
                            <div class="col-md-4 col-sm-9 col-xs-7 c-cart-desc">
                                <h3>
                                    <a href="shop-product-details-2.html" class="c-font-bold c-theme-link c-font-22 c-font-dark">{{ $product['item']->name }}</a>
                                </h3>
                            ...
                            <div class="col-md-1 col-sm-3 col-xs-6 c-cart-qty">
                                ...
                                <div class="c-input-group c-spinner">
                                    <input type="text" class="form-control c-item-1" value="{{ $product['qty'] }}">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-6 c-cart-price">
                                <p class="c-cart-price c-font-bold">$ {{ $product['item']->price }}</p>
                            </div>
                    ...
                    <div class="c-cart-buttons">
                        ...
                        <a href="{{ URL::to('shop/checkout') }}" class="btn c-btn btn-lg c-theme-btn c-btn-square c-font-white c-font-bold c-font-uppercase c-cart-float-r">Checkout</a>
                    </div>
                    @else
                        <div class="row c-cart-table-title">
