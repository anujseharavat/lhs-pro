            ...
            <div class="c-navbar-wrapper clearfix">
                <div class="c-brand c-pull-left">
                    <!--<a href="index-2.html" class="c-logo">
                        <img src="assets/base/img/layout/logos/logo-3.png" alt="Lets Home Study" class="c-desktop-logo">
                        <img src="assets/base/img/layout/logos/logo-3.png" alt="Lets Home Study" class="c-desktop-logo-inverse">
                        <img src="assets/base/img/layout/logos/logo-3.png" alt="Lets Home Study" class="c-mobile-logo"> </a>-->
            ...
            <div class="c-body">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <ul class="c-links c-theme-ul">
                            <li>
                                <a href="#">About Lets Home Study</a>
                            </li>
                            <li>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        ...
                        <p class="c-address c-font-16"> 7, Jalan Sri Klebang 17, Bandar Baru Sri
                            <br/> Ipoh, Perak, Malaysia
                            <br/> Phone: 800 123 3456
                            <br/> Fax: 800 123 3456
                            <br/> Email:
                            <a href="mailto:info@Lets Home Study.com">
                                <span class="c-theme-color">info@Lets Home Study.com</span>
                            </a>
                            <br/> Skype:
                            <a href="#">
                    ...
                    <div class="col-md-7">
                        <div class="c-content-title-1 c-title-md">
                            <h3 class="c-font-uppercase c-font-bold">About
                                <span class="c-theme-font">Lets Home Study</span>
                            </h3>
                            <div class="c-line-left hide"></div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12 c-col">
                    <p class="c-copyright c-font-grey">2015 &copy; Lets Home Study
...
<!-- Mirrored from themehats.com/themes/Lets Home Study/shop-order-history-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Feb 2016 11:47:48 GMT -->
</html>