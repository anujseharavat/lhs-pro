<div class="modal-body">
    ...
    <form method="post" action="user/register">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control input-lg c-square" id="firstName" name="firstName"
                   placeholder="First Name" value="a" required></div>
        <div class="form-group">
            <label for="lastName" class="hide">Last Name</label>
            <input type="text" class="form-control input-lg c-square" id="lastName" name="lastName"
